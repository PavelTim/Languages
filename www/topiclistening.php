...
if (isset($_SESSION['Students_login']))
	...
	echo ("<span class=\"label label-pill  label-success\"> 3. Лексика</span></h3> ");
	echo ("<h1><center><span class=\"label label-pill  label-warning\"> 4. Аудирование</span></center></h1> ");
	echo ("<h3><span class=\"label label-pill  label-danger\"> 5. Письмо</span> ");
...
//echo ("<p><center><br><h3>Раздел \"Аудирование\". Прослушайте аудиозапись и ответьте на вопросы.</h3></center></p>");
